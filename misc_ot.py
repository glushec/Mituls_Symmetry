...
class NTZSYM_OT_NtzResetAllSettings(Operator):
    ...
    bl_label = "Mituls - Symmetry - Reset all Settings"
...
class NTZSYM_OT_writeicontofile(Operator):
    ...
    bl_label = "Mituls - Symmetry - Write Icon to File"
...
class NTZSYM_OT_applyorremovemodifier(Operator):
    ...
    bl_label = "Mituls - Symmetry - Remove or Apply Mirror Modifier"
    ...
    def execute(self, context):
        ...
        for obj in selObjs:
            ...
            if mirrorParent is not None:
                ...
                bisectModifier = miscFunc.findModifier(obj=mirrorParent, modifierType='BOOLEAN', modifierName='Mituls - Bisect')
            ...
            bisectModifier = miscFunc.findModifier(obj=obj, modifierType='BOOLEAN', modifierName='Mituls - Bisect')
            if bisectModifier is not None:
